...
(() => {
  ...
  var findByProps2, findByPropsLazy, findByPropsAll, findByName, findByNameLazy, findByNameAll, findByDisplayName, findByDisplayNameLazy, findByDisplayNameAll, findByTypeName, findByTypeNameLazy, findByTypeNameAll, findByStoreName, findByStoreNameLazy, findByFilePath, findByFilePathLazy;
  var init_wrappers = __esm({
    "src/metro/wrappers.ts"() {
      ...
      init_finders();
      init_lazy2();
      findByProps2 = (...props) => findExports(byProps(...props));
  ...
  var init_constants = __esm({
    "src/lib/utils/constants.ts"() {
      ...
      init_asyncIteratorSymbol();
      init_promiseAllSettled();
      DISCORD_SERVER = "https://discord.com/invite/n8WvR8Be9w";
      GITHUB = "https://github.com/true1ann/neocord-xposed/";
  ...
  var init_themes = __esm({
    "src/lib/addons/themes/index.ts"() {
      ...
      mmkvStorage = proxyLazy(() => {
        var newModule = findByProps2("impl");
        if (typeof newModule?.impl === "object")
          return newModule.impl;
        return findByProps2("storage");
      });
      ...
      ({ MessagesWrapper } = lazyDestructure(() => findByProps2("MessagesWrapper")));
  ...
  var init_components = __esm({
    "src/metro/common/components.ts"() {
      ...
      findProp = (prop) => proxyLazy(() => findByProps2(prop)[prop]);
      ...
      SafeAreaView = proxyLazy(() => findByProps2("useSafeAreaInsets").SafeAreaView);
      ...
      Card = findProp("Card");
      RedesignCompat = proxyLazy(() => findByProps2("RedesignCompat").RedesignCompat);
  ...
  var init_common = __esm({
    "src/metro/common/index.ts"() {
      ...
      FluxDispatcher = findByProps2("_interceptors");
  ...
  var init_default = __esm({
    "src/core/i18n/default.json"() {
      default_default = {
        ...
        LOAD_FROM_CUSTOM_URL_DEC: "Load NeoCord (Or others) from a custom endpoint",
        ...
        URL_PLACEHOLDER: "https://github.com/true1ann/neocord-xposed",
        VERSION: "Version",
        VERSIONS: "Versions",
        CUSTOMCMD: "Custom Commands",
        EX_PB: "NC:BUN Plugin Browser",
        CRASH_HEADER: "A crash occured while rendering a component. This could be caused by a plugin, NeoCord or Discord itself."
      };
    }
  });
    ...
    var cb = /* @__PURE__ */ function() {
      var _ref = _async_to_generator(function* ({ locale }) {
        ...
        if (!_loadedLocale.has(resolvedLocale)) {
          ...
          try {
            var localFileResponse = yield fetch(`./${resolvedLocale}.json`);
            if (localFileResponse.ok) {
              var strings = yield localFileResponse.json();
          ...
          fetch(`https://raw.githubusercontent.com/pyoncord/i18n/main/resources/${resolvedLocale}/bunny.json`).then((r) => r.json()).then((strings2) => {
            _loadedStrings[resolvedLocale] = strings2;
  ...
  var init_toasts = __esm({
    "src/lib/ui/toasts.ts"() {
      ...
      init_common();
      init_wrappers();
      ({ uuid4 } = lazyDestructure(() => findByProps2("uuid4")));
  ...
  var init_AlertModal = __esm({
    "src/lib/ui/components/wrappers/AlertModal.tsx"() {
      ...
      ({ AlertModal: _AlertModal, AlertActionButton: _AlertActionButton } = lazyDestructure(() => findByProps2("AlertModal", "AlertActions")));
  ...
  var init_styles = __esm({
    "src/lib/ui/styles.ts"() {
      ...
      ({ ThemeContext } = lazyDestructure(() => findByProps2("ThemeContext"), {
        hint: "object"
      }));
      ({ TextStyleSheet } = lazyDestructure(() => findByProps2("TextStyleSheet")));
    }
  });
  ...
  var init_logo = __esm({
    "src/assets/icons/logo.png"() {
      logo_default = "data:image/png;base64,";
    }
  });
  ...
  var init_AddonPage = __esm({
    "src/core/ui/components/AddonPage.tsx"() {
      ...
      ({ showSimpleActionSheet, hideActionSheet } = lazyDestructure(() => findByProps2("showSimpleActionSheet")));
      ({ openAlert, dismissAlert } = lazyDestructure(() => findByProps2("openAlert", "dismissAlert")));
      useSafeAreaInsets = proxyLazy(() => findByProps2("useSafeAreaInsets").useSafeAreaInsets);
    }
  });
        ...
        evalPlugin(plugin) {
          return _async_to_generator(function* () {
            var vendettaForPlugins = {
              ...
              logger: new LoggerClass(`NeoCord \xBB ${plugin.manifest.name}`)
            };
...
//# sourceURL=${plugin.id}`;
  ...
  var init_forumPost = __esm({
    "src/core/plugins/quickinstall/forumPost.tsx"() {
      ...
      init_components2();
      init_toasts();
      ({ useFirstForumPostMessage } = lazyDestructure(() => findByProps2("useFirstForumPostMessage")));
  ...
  var init_url = __esm({
    "src/core/plugins/quickinstall/url.tsx"() {
      ...
      ({ getChannel } = lazyDestructure(() => findByProps2("getChannel")));
      url_default = () => {
  ...
  var init_Plugins = __esm({
    "src/core/ui/settings/pages/Plugins/index.tsx"() {
      ...
      init_bunny();
      init_vendetta();
      ({ openAlert: openAlert2 } = lazyDestructure(() => findByProps2("openAlert", "dismissAlert")));
      ({ AlertModal: AlertModal2, AlertActions, AlertActionButton: AlertActionButton2 } = lazyDestructure(() => findByProps2("AlertModal", "AlertActions")));
    }
  });
  ...
  function PluginCard2(props) {
    ...
    return /* @__PURE__ */ jsxs(Card, {
      children: [
        !plugin && /* @__PURE__ */ jsx(import_react_native20.View, {
          style: {
            justifyContent: "center",
            alignItems: "center"
          },
  ...
  function BrowserPage() {
    ...
    return /* @__PURE__ */ jsx(FlashList, {
      ...
      renderItem: ({ item: manifest }) => /* @__PURE__ */ jsx(import_react_native20.View, {
        style: {
          paddingVertical: 6,
          paddingHorizontal: 8
        },
  ...
  var import_react6, import_react_native20, queryClient;
  ...
  var import_react_native21, hideActionSheet2, showSimpleActionSheet3, useStyles3;
  var init_AddonCard = __esm({
    "src/core/ui/components/AddonCard.tsx"() {
      ...
      ({ hideActionSheet: hideActionSheet2 } = lazyDestructure(() => findByProps2("openLazy", "hideActionSheet")));
      ({ showSimpleActionSheet: showSimpleActionSheet3 } = lazyDestructure(() => findByProps2("showSimpleActionSheet")));
  ...
  var import_react7, import_react_native22, actionSheet2, openAlert3, AlertModal3, AlertActionButton3;
  var init_FontEditor = __esm({
    "src/core/ui/settings/pages/Fonts/FontEditor.tsx"() {
      ...
      ({ openAlert: openAlert3 } = lazyDestructure(() => findByProps2("openAlert", "dismissAlert")));
      ({ AlertModal: AlertModal3, AlertActionButton: AlertActionButton3 } = lazyDestructure(() => findByProps2("AlertModal", "AlertActions")));
    }
  });
  ...
  var Skia, import_react8, import_react_native23, useToken;
  var init_FontCard = __esm({
    "src/core/ui/settings/pages/Fonts/FontCard.tsx"() {
      ...
      init_FontEditor();
      ({ useToken } = lazyDestructure(() => findByProps2("useToken")));
    }
  });
  ...
  function AssetDisplay({ asset }) {
    return /* @__PURE__ */ jsx(TableRow, {
      ...
      icon: displayable.has(asset.type) ? /* @__PURE__ */ jsx(import_react_native24.Image, {
        source: asset.index,
        style: {
          width: 32,
          height: 32
...
Type: ${asset.type}`,
        extraContent: displayable.has(asset.type) ? /* @__PURE__ */ jsx(import_react_native24.Image, {
          resizeMode: "contain",
          source: asset.index,
          style: {
            flex: 1,
  ...
  var import_react_native24, openAlert4, AlertModal4, AlertActionButton4, displayable, iconMap, copyToClipboard;
  var init_AssetDisplay = __esm({
    "src/core/ui/settings/pages/Developer/AssetDisplay.tsx"() {
      ...
      ({ openAlert: openAlert4 } = lazyDestructure(() => findByProps2("openAlert", "dismissAlert")));
      ({ AlertModal: AlertModal4, AlertActionButton: AlertActionButton4 } = lazyDestructure(() => findByProps2("AlertModal", "AlertActions")));
  ...
  function Developer() {
    ...
    return /* @__PURE__ */ jsx(ErrorBoundary, {
      children: /* @__PURE__ */ jsx(import_react_native27.ScrollView, {
        style: {
          flex: 1
        },
        contentContainerStyle: {
                ...
                isReactDevToolsPreloaded() && /* @__PURE__ */ jsx(Fragment, {
                  children: /* @__PURE__ */ jsx(TableRow, {
                    ...
                    onPress: () => window[getReactDevToolsProp() || "__vendetta_rdc"]?.connectToDevTools({
                      ...
                      resolveRNStyle: import_react_native27.StyleSheet.flatten
                    })
                  })
                })
              ]
                      ...
                      actions: /* @__PURE__ */ jsxs(Stack, {
                        children: [
                          /* @__PURE__ */ jsx(AlertActionButton5, {
                            text: Strings.RELOAD,
                            variant: "destructive",
                            onPress: () => import_react_native26.NativeModules.BundleUpdaterManager.reload()
                          }),
                          /* @__PURE__ */ jsx(AlertActionButton5, {
                            text: Strings.CANCEL,
                            variant: "secondary"
  ...
  var import_react_native26, import_react_native27, hideActionSheet3, showSimpleActionSheet4, openAlert5, AlertModal5, AlertActionButton5, RDT_EMBED_LINK, useStyles4;
  var init_Developer = __esm({
    "src/core/ui/settings/pages/Developer/index.tsx"() {
      ...
      ({ hideActionSheet: hideActionSheet3 } = lazyDestructure(() => findByProps2("openLazy", "hideActionSheet")));
      ({ showSimpleActionSheet: showSimpleActionSheet4 } = lazyDestructure(() => findByProps2("showSimpleActionSheet")));
      ({ openAlert: openAlert5 } = lazyDestructure(() => findByProps2("openAlert", "dismissAlert")));
      ({ AlertModal: AlertModal5, AlertActionButton: AlertActionButton5 } = lazyDestructure(() => findByProps2("AlertModal", "AlertActions")));
  ...
  // src/core/ui/settings/pages/nc_commands/index.tsx
  var nc_commands_exports = {};
  __export(nc_commands_exports, {
    default: () => main
  });
  function main() {
    var showAlert = () => {
      openAlert6("test-alert", /* @__PURE__ */ jsx(AlertModal6, {
        title: "Test",
        content: "This is a test popup.",
        actions: /* @__PURE__ */ jsx(AlertActions2, {
          children: /* @__PURE__ */ jsx(AlertActionButton6, {
            text: "Dismiss",
            variant: "primary",
            onPress: () => {
            }
      ...
      children: /* @__PURE__ */ jsx(Card, {
        children: /* @__PURE__ */ jsxs(import_react_native28.View, {
          ...
          children: [
            ...
            /* @__PURE__ */ jsx(Text, {
              variant: "text-md/medium",
              children: "This is a sample card with a button."
            }),
            /* @__PURE__ */ jsx(Button, {
              size: "lg",
              text: "Open Popup",
  ...
  var import_react10, import_react_native28, openAlert6, AlertModal6, AlertActions2, AlertActionButton6;
  var init_nc_commands = __esm({
    "src/core/ui/settings/pages/nc_commands/index.tsx"() {
      "use strict";
      init_asyncIteratorSymbol();
      init_promiseAllSettled();
      ...
      init_components();
      init_lazy();
      ({ openAlert: openAlert6 } = lazyDestructure(() => findByProps("openAlert", "dismissAlert")));
      ({ AlertModal: AlertModal6, AlertActions: AlertActions2, AlertActionButton: AlertActionButton6 } = lazyDestructure(() => findByProps("AlertModal", "AlertActions")));
    }
  });
    ...
    registerSection({
      ...
      items: [
        ...
        },
        {
          ...
          render: () => Promise.resolve().then(() => (init_nc_commands(), nc_commands_exports))
        }
      ]
    });
    registerSection({
  ...
  var import_react11, import_react_native29, initVendettaObject;
  var init_api3 = __esm({
    "src/core/vendetta/api.tsx"() {
      "use strict";
      init_asyncIteratorSymbol();
        ...
        var api = window.vendetta = {
          ...
          metro: {
            ...
            findByProps: (...props) => {
              ...
              var ret = findByProps2(...props);
              if (ret == null) {
                if (props.includes("ActionSheetTitleHeader")) {
                  var module = findByProps2("ActionSheetRow");
                  return {
                    ...module,
                    ...
                    ActionSheetContentContainer: ({ children }) => {
                      ...
                      return /* @__PURE__ */ (0, import_react11.createElement)(import_react_native29.View, null, children);
                    }
                  };
                }
              }
